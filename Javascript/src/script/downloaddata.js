export class DownloadExampleFiles {
    ...
    downloadCSV() {
        let csv = 'Name,EmployeeID,Role,Department,Location,Phone,Email,Supervisor Name,Supervisor ID,Image URL\n';
    ...
    downloadXML() {
        const xmltext = '<?xml version="1.0" encoding="utf-8" ?><people>' +
