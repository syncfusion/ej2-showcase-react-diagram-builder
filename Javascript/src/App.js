...
import { CommonKeyboardCommands } from './script/commoncommands';
import { CustomTool } from './script/userhandles';
import { DiagramTheme } from './script/themes';
import { PageCreation } from './script/pages';
import { DropDownDataSources } from './script/dropdowndatasource';
import { DiagramPropertyBinding, MindMapPropertyBinding } from './script/events';
...
import { DiagramBuilderLayer } from './script/layers';
...
export let toolbarHorVerAlignment;
...
class App extends React.Component {
    constructor(props) {
        ...
        this.commandManager = this.getCommandSettings();
        ...
        this.customTool = new CustomTool(this.selectedItem);
        this.getCustomTool = this.customTool.getTool.bind(this);
        ...
        this.moreShapesButtons = this.getDialogButtons('moreshapes');
        ...
        this.listViewFields = { isChecked: 'checked' };
    ...
    ;
    mindmapItemTemplate(data) {
        return (<div className='db-ddl-template-style'><span className={data.className}/></div>);
    }
    ;
    // set the value to value template
    mindmapValueTemplate(data) {
        return (<div className='db-ddl-template-style'><span className={data.className}/></div>);
    }
    ;
    getFileMenuItems() {
    ...
    themeDialogCreated(args) {
        const themeDialogContent = document.getElementById('themeDialogContent');
    ...
    loadPage() {
        ...
        this.selectedItem.mindmapSettings.levelType = this.mindMapLevel;
        this.selectedItem.mindmapSettings.fill = this.mindmapFill;
        this.selectedItem.mindmapSettings.strokeStyle = this.mindmapStrokeStyle;
        this.selectedItem.mindmapSettings.stroke = this.mindMapStroke;
        this.selectedItem.mindmapSettings.strokeWidth = this.mindmapStrokeWidth;
        this.selectedItem.mindmapSettings.opacity = this.mindmapOpacity;
        this.selectedItem.mindmapSettings.textOpacity = this.mindmapOpacityText;
        this.selectedItem.mindmapSettings.fontFamily = this.ddlTextPosition;
        this.selectedItem.mindmapSettings.fontSize = this.mindmapFontSize;
        this.selectedItem.mindmapSettings.fontColor = this.mindmapTextColor;
    ...
    menuClick(args) {
        ...
        switch (commandType.toLowerCase()) {
            ...
            case 'showgrid':
                ...
                args.item.iconCss = args.item.iconCss ? '' : 'sf-icon-Selection';
                let container = document.getElementsByClassName('db-current-diagram-container')[0];
    ...
    menumouseover(args) {
        ...
        if (target && (target.className === 'e-control e-dropdown-btn e-lib e-btn db-dropdown-menu' ||
            ...
            const button1 = target.ej2_instances[0];
    ...
    hideMenuBar() {
        const expandcollapseicon = document.getElementById('btnHideToolbar');
        const button1 = expandcollapseicon.ej2_instances[0];
    ...
    beforeItemRender(args) {
        ...
        const status = this.selectedItem.utilityMethods.enableMenuItems(args.item.text, this.selectedItem);
        if (status) {
    ...
    themeTemplate() {
        return (<div id="themeDialogContent">
                <div className="row">
    ...
    deleteConformationTemplate() {
        return (<div id='deleteConfirmationContent'>
    ...
    tootipTemplate() {
        return (<div id="tooltipDialogContent">
                <div className="row">
                    <div>
    ...
    moreShapeTemplate() {
        return (<div id="moreShapesDialogContent">
                <div className="row">
                    <div className="col-xs-3 temp-left-pane">
                        <ListViewComponent ref={moreShapesList => this.moreShapesList = moreShapesList} id='moreShapesList' dataSource={this.dropDownDataSources.listViewData} fields={this.listViewFields} showCheckBox={true} select={this.listViewSelectionChange}/>
                    </div>
    ...
    saveTemplate() {
        return (<div id="saveDialogContent">
                <div className="row">
    ...
    fileTemplate() {
        return (<div id="uploadDialogContent" className="db-upload-content firstPage">
                ...
                <div id='uploadInformationDiv' className="row db-dialog-prop-row" style={{ marginTop: "0px" }}>
                    <div className="row">
                        ...
                        <div className="row db-dialog-child-prop-row">
                            <div className="col-xs-3 db-prop-col-style">
                                <RadioButtonComponent id='csvFormat' label="csv" name="uploadFileFormat" checked={true} change={this.downloadFile.downloadFormatChange.bind(this.downloadFile)}/>
                            </div>
                            <div className="col-xs-3 db-prop-col-style">
                    ...
                    <div className="row">
                        <div id="dropArea">
                            ...
                            <UploaderComponent ref={defaultupload => this.defaultupload = defaultupload} id='defaultfileupload' asyncSettings={this.path} success={uploadChange} failure={this.onUploadFailure} progress={this.onUploadFileSelected} allowedExtensions={this.selectedItem.orgDataSettings.extensionType}/>
                        </div>
                    </div>
                </div>
                <div id='parentChildRelationDiv' className="row db-dialog-prop-row">
                    <div className="row db-dialog-child-prop-row" style={{ marginTop: "20px" }}>
                        ...
                        <div className="row db-dialog-child-prop-row">
                            <DropDownListComponent ref={dropdown => this.ddlTextPosition = dropdown} id="employeeId" change={this.orgChartPropertyBinding.orgDropDownChange.bind(this.orgChartPropertyBinding)} dataSource={this.selectedItem.orgDataSettings.dataSourceColumns} fields={this.dropdownListFields}/>
                        </div>
                    </div>
                    <div className="row db-dialog-prop-row">
                        <div className="row">
                        ...
                        <div className="row db-dialog-child-prop-row">
                            <DropDownListComponent ref={dropdown => this.ddlTextPosition = dropdown} id="superVisorId" change={this.orgChartPropertyBinding.orgDropDownChange.bind(this.orgChartPropertyBinding)} dataSource={this.selectedItem.orgDataSettings.dataSourceColumns} fields={this.dropdownListFields}/>
                ...
                <div id='moreInformationDiv' className="row db-dialog-prop-row">
                    <div id='bindingFields' className="row">
                        ...
                        <div className="row db-dialog-child-prop-row">
                            <DropDownListComponent ref={dropdown => this.ddlTextPosition = dropdown} id="orgNameField" change={this.orgChartPropertyBinding.orgDropDownChange.bind(this.orgChartPropertyBinding)} dataSource={this.selectedItem.orgDataSettings.dataSourceColumns} fields={this.dropdownListFields}/>
                    ...
                    <div id='bindingFields' className="row db-dialog-prop-row" style={{ marginTop: "20px" }}>
                        ...
                        <div className="row db-dialog-child-prop-row">
                            <MultiSelectComponent id="orgBindingFields" change={this.orgChartPropertyBinding.orgMultiSelectChange.bind(this.orgChartPropertyBinding)} dataSource={this.selectedItem.orgDataSettings.dataSourceColumns} fields={this.dropdownListFields} mode='Delimiter'/>
                        </div>
                    </div>
                    <div id='imageFields' className="row db-dialog-prop-row">
                        ...
                        <div className="row db-dialog-child-prop-row">
                            <DropDownListComponent ref={dropdown => this.ddlTextPosition = dropdown} id="orgImageField" change={this.orgChartPropertyBinding.orgDropDownChange.bind(this.orgChartPropertyBinding)} dataSource={this.selectedItem.orgDataSettings.dataSourceColumns} fields={this.dropdownListFields}/>
                        </div>
                    </div>
                    <div id='additionalFields' className="row db-dialog-prop-row">
                        ...
                        <div className="row db-dialog-child-prop-row">
                            <MultiSelectComponent id="orgAdditionalField" change={this.orgChartPropertyBinding.orgMultiSelectChange.bind(this.orgChartPropertyBinding)} dataSource={this.selectedItem.orgDataSettings.dataSourceColumns} fields={this.dropdownListFields} mode='Delimiter'/>
                        </div>
                    </div>
                </div>
    ...
    drop(args) {
        if (this.selectedItem.diagramType === 'OrgChart') {
            ...
            if (sourceNode !== null && sourceNode.id !== 'rootNode' && args.target instanceof Node) {
                const targetNode = args.target;
                const connector = diagram.getObject(sourceNode.inEdges[0]);
    ...
    showHideLayers() {
        ...
        const iconCss = btnWindow.ej2_instances[0].items[3].iconCss;
    ...
    showHideThemes() {
        const btnWindow = document.getElementById('btnWindowMenu');
        const iconCss = btnWindow.ej2_instances[0].items[5].iconCss;
        if (iconCss) {
    ...
    showColorPicker(propertyName, toolbarName) {
        const value = document.getElementById(propertyName);
        const fillElement = value.parentElement.getElementsByClassName('e-dropdown-btn')[0];
        fillElement.click();
        const popupElement = document.getElementById(fillElement.id + '-popup');
        const bounds = document.getElementsByClassName(toolbarName)[0].getBoundingClientRect();
    ...
    arrangeContextMenuOpen(args) {
        if (args.element.classList.contains('e-menu-parent')) {
            const popup = document.querySelector('#btnArrangeMenu-popup');
    ...
    zoomTemplate() {
        return (<div id="template_toolbar">
                <DropDownButtonComponent id="btnZoomIncrement" items={this.zoomMenuItems} content={this.selectedItem.scrollSettings.currentZoom} select={zoomchange}/>
            </div>);
    }
    drawShapeTemplate() {
        return (<div id="template_toolbar">
    ...
    mindmapOpacityChangeEvent(args) {
        this.selectedItem.mindmapSettings.opacity.value = args.value;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'opacity', propertyValue: args });
    }
    mindmapFontOpacityChangeEvent(args) {
        this.selectedItem.mindmapSettings.opacity.value = args.value;
    ...
    DiagrammindMapLevel(args) {
        this.selectedItem.mindmapSettings.levelType.value = args.value;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'levelType', propertyValue: args });
    }
    mindmapFillColorChange(args) {
        this.selectedItem.mindmapSettings.fill.value = args.currentValue.hex;
    ...
    mindMapStrokeChangeEvent(args) {
        this.selectedItem.mindmapSettings.stroke.value = args.currentValue.hex;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'stroke', propertyValue: args });
    }
    mindmapStorkeStyleChangeEvent(args) {
        this.selectedItem.mindmapSettings.strokeStyle.value = args.value;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'strokeStyle', propertyValue: args });
    }
    mindmapStrokewidthChangeEvent(args) {
        this.selectedItem.mindmapSettings.strokeWidth.value = args.value;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'strokeWidth', propertyValue: args });
    }
    mindmapFontSizeChangeEvent(args) {
        this.selectedItem.mindmapSettings.fontSize.value = args.value;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'fontSize', propertyValue: args });
    }
    mindmapFontfamilyTextEvent(args) {
        this.selectedItem.mindmapSettings.fontFamily.value = args.value;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'fontFamily', propertyValue: args });
    }
    mindmapFontColorChangeEvent(args) {
        this.selectedItem.mindmapSettings.fontColor.value = args.currentValue.hex;
        this.selectedItem.mindMapPropertyChange({ propertyName: 'fontColor', propertyValue: args });
    }
    render() {
        return (<div>
                <ContextMenuComponent id='arrangeContextMenu' ref={arrangeContextMenu => (this.arrangeContextMenu) = arrangeContextMenu} animationSettings={this.animationSettings} items={this.dropDownDataSources.arrangeMenuItems} onOpen={contextMenuOpenChange} cssClass="arrangeMenu" beforeItemRender={beforItem} select={contextMenuClickEvent} beforeClose={() => this.arrangeMenuBeforeClose}/>
            ...
            textOverflow: "ellipse", whiteSpace: "nowrap"
                            ...
                            <div className='db-menu-container'>
                                <div className="db-menu-style">
                                    <DropDownButtonComponent id="btnFileMenu" cssClass={"db-dropdown-menu"} content="File" items={this.dropDownDataSources.fileMenuItems} beforeItemRender={beforItem} beforeOpen={beforeOpen} beforeClose={beforeClose} select={menuclick}/>
                                </div>
                                <div className="db-menu-style">
                                    <DropDownButtonComponent id="btnEditMenu" cssClass={"db-dropdown-menu"} content="Edit" items={this.dropDownDataSources.editMenuItems} beforeItemRender={beforItem} beforeOpen={beforeOpen} beforeClose={beforeClose} select={menuclick}/>
                                </div>
                                <div className="db-menu-style">
                                    <DropDownButtonComponent id="btnViewMenu" cssClass={"db-dropdown-menu"} content="View" items={this.dropDownDataSources.viewMenuItems} beforeItemRender={beforItem} beforeOpen={beforeOpen} beforeClose={beforeClose} select={menuclick}/>
                                </div>
                                <div className="db-menu-style">
                                    <DropDownButtonComponent id="btnArrangeMenu" cssClass={"db-dropdown-menu"} content="Arrange" target='.e-contextmenu-wrapper.arrangeMenu' items={this.dropDownDataSources.arrangeMenuItems} beforeItemRender={beforItem} beforeOpen={beforeOpen} beforeClose={beforeClose} select={menuclick}/>
                                </div>
                                <div className="db-menu-style">
                                    <DropDownButtonComponent id="btnWindowMenu" cssClass={"db-dropdown-menu"} content="Window" items={this.dropDownDataSources.windowMenuItems} beforeItemRender={beforItem} beforeOpen={beforeOpen} beforeClose={beforeClose} select={menuclick}/>
                                </div>
                                <div className="db-menu-style" style={{ display: "none" }}>
                                    <DropDownButtonComponent id="btnHelpMenu" cssClass={"db-dropdown-menu"} content="Help" items={this.dropDownDataSources.helpMenuItems} beforeItemRender={beforItem} beforeOpen={beforeOpen} beforeClose={beforeClose} select={menuclick}/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='row content'>
                        <div className='sidebar show-overview'>
                            <div className="db-palette-parent">
                                <SymbolPaletteComponent ref={symbolpalette => (this.symbolpalette) = symbolpalette} id="symbolpalette" width="100%" height="100%" symbolHeight={50} symbolWidth={50} expandMode={this.palettes.expandMode} palettes={this.palettes.palettes} enableSearch={this.palettes.enableSearch} symbolPreview={this.palettes.symbolPreview} symbolMargin={this.palettes.symbolMargin} getSymbolInfo={this.palettes.getSymbolInfo} getNodeDefaults={this.palettes.setPaletteNodeDefaults}/>
                            </div>
                        ...
                        <div className='main-content' role='main'>
                            <div className="db-diagram-container">
                                <div id="diagramContainerDiv" className='db-current-diagram-container'>
                                    <DiagramComponent ref={diagram => (this.diagram = diagram)} id="diagram" width={"100%"} height={"100%"} snapSettings={this.snapSettings} pageSettings={this.pageSettings} scrollSettings={this.scrollSettings} selectedItems={this.selectedItems} getNodeDefaults={nodeDefault} getConnectorDefaults={connectordefault} commandManager={this.commandManager} backgroundColor="transparent" contextMenuSettings={this.contextMenuSettings} selectionChange={this.diagramEvents.selectionChange.bind(this.diagramEvents)} positionChange={this.diagramEvents.nodePositionChange.bind(this.diagramEvents)} sizeChange={this.diagramEvents.nodeSizeChange.bind(this.diagramEvents)} rotateChange={this.diagramEvents.nodeRotationChange.bind(this.diagramEvents)} contextMenuOpen={contextMenuchange} contextMenuClick={this.diagramEvents.diagramContextMenuClick.bind(this.diagramEvents)} dragEnter={this.diagramEvents.dragEnter.bind(this.diagramEvents)} historyChange={this.diagramEvents.historyChange.bind(this.diagramEvents)} scrollChange={this.diagramEvents.scrollChange.bind(this.diagramEvents)} collectionChange={collectionChange} drop={dropElement} getCustomTool={this.getCustomTool} textEdit={this.diagramEvents.textEdit.bind(this.diagramEvents)}/>
                                </div>
                                    ...
                                    <div id='diagramPropertyContainer' className="db-diagram-prop-container">
                                        ...
                                        <div className="row db-prop-row" id="pageOrientation">
                                            <div className="col-xs-3 db-prop-col-style" style={{ marginRight: "8px", width: "30%" }}>
                                                <RadioButtonComponent id="pagePortrait" label="Portrait" name="pageSettings" checked={this.selectedItem.pageSettings.isPortrait} change={this.diagramPropertyBinding.pageOrientationChange.bind(this.diagramPropertyBinding)}/>
                                            </div>
                                            <div className="col-xs-3 db-prop-col-style">
                                                <RadioButtonComponent id="pageLandscape" label="Landscape" name="pageSettings" change={this.diagramPropertyBinding.pageOrientationChange.bind(this.diagramPropertyBinding)} checked={this.selectedItem.pageSettings.isLandscape}/>
                                            </div>
                                        </div>
        ...
        change={rotationChange}/>
                                ...
                                <div id='mindMapContainer' className="db-mindmap-prop-container">
                                    ...
                                    <div className="row db-prop-row">
                                        <div className="col-xs-6 db-col-left">
                                            <DropDownListComponent ref={mindMapLevel => this.mindMapLevel = mindMapLevel} id="mindMapLevels" value={this.selectedItem.mindmapSettings.levelType} dataSource={this.dropDownDataSources.mindmapLevels} fields={this.dropdownListFields} change={mindMapLavelChange}/>
                                        </div>
                                    </div>
                                    <div id='mindMapFill' className="row db-prop-row">
                                        <div className="col-xs-6 db-col-left">
                                            <div className="db-color-container">
                                                <div className="db-color-input">
                                                    <ColorPickerComponent ref={mindmapFill => this.mindmapFill = mindmapFill} mode="Palette" id='mindmapFill' type="color" value={this.selectedItem.mindmapSettings.fill} change={mindmapFillColor}/>
                                                </div>
                                                <div className="db-color-btn">
                                                    <ButtonComponent iconCss='sf-icon-Pickers tb-icons'/>
                                                </div>
                                    ...
                                    <div className="row db-prop-row">
                                        <div className="col-xs-4 db-col-left">
                                            <div className="db-color-container">
                                                <div className="db-color-input">
                                                    <ColorPickerComponent ref={mindMapStroke => this.mindMapStroke = mindMapStroke} id='mindmapStroke' mode="Palette" value={this.selectedItem.mindmapSettings.stroke} type="color" change={mindMapSrtokeChange}/>
                                                </div>
                                                <div className="db-color-btn">
                                                    <ButtonComponent iconCss='sf-icon-Pickers tb-icons'/>
                                                </div>
                                        ...
                                        <div className="col-xs-4 db-col-center">
                                            <DropDownListComponent ref={mindmapStrokeStyle => this.mindmapStrokeStyle = mindmapStrokeStyle} value={this.selectedItem.mindmapSettings.strokeStyle} dataSource={this.dropDownDataSources.borderStyles} fields={this.dropdownListFields} itemTemplate={this.mindmapItemTemplate} valueTemplate={this.mindmapValueTemplate} change={mindmapStrokeStyleChange}/>
                                        </div>
                                        <div className="col-xs-4 db-col-right">
                                            <NumericTextBoxComponent ref={mindmapStrokeWidth => this.mindmapStrokeWidth = mindmapStrokeWidth} id="mindmapStrokeWidth" min={0.5} step={0.5} value={this.selectedItem.mindmapSettings.strokeWidth} change={mindmapStrokeWidthChange}/>
                                        </div>
                                    </div>
                                    <div className="row db-prop-row">
                                        <div className="col-xs-2 db-col-right db-prop-text-style" style={{ paddingTop: "6px" }}>
                                        ...
                                        <div className="col-xs-8 db-col-left" style={{ paddingRight: "10px" }}>
                                            <SliderComponent ref={mindmapOpacity => this.mindmapOpacity = mindmapOpacity} value={this.selectedItem.mindmapSettings.opacity} min={0} max={100} step={10} type='MinRange' change={mindmapOpacityChange}/>
                                        </div>
                                        <div className="col-xs-2 db-col-right">
                                    ...
                                    <div className="row db-prop-row">
                                        <div className="col-xs-8 db-col-left">
                                            <DropDownListComponent ref={dropdown => this.ddlTextPosition = dropdown} dataSource={this.dropDownDataSources.fontFamilyList} value={this.selectedItem.mindmapSettings.fontFamily} fields={this.dropdownListFields} change={mindmapFontfamilyText}/>
                                        </div>
                                        <div className="col-xs-4 db-col-right">
                                            <NumericTextBoxComponent ref={mindmapFontSize => this.mindmapFontSize = mindmapFontSize} min={1} step={1} value={this.selectedItem.mindmapSettings.fontSize} change={mindmapFontSizeChange}/>
                                        </div>
                                    </div>
                                    <div className="row db-prop-row">
                                        <div className="col-xs-6 db-col-left">
                                        ...
                                        <div className="col-xs-6 db-col-right" id="textColorDiv">
                                            <div className="db-color-container">
                                                <div className="db-color-input">
                                                    <ColorPickerComponent id='mindmapTextColor' ref={mindmapTextColor => this.mindmapTextColor = mindmapTextColor} mode="Palette" type="color" value={this.selectedItem.mindmapSettings.fontColor} change={mindmapFontColorChange}/>
                                                </div>
                                                <div className="db-color-btn">
                                                    <ButtonComponent iconCss='sf-icon-ColorPickers tb-icons'/>
                                                </div>
                                    ...
                                    <div className="row db-prop-row">
                                        ...
                                        <div className="col-xs-8 db-col-left" style={{ paddingRight: "10px" }}>
                                            <SliderComponent ref={mindmapOpacityText => this.mindmapOpacityText = mindmapOpacityText} value={this.selectedItem.mindmapSettings.textOpacity} min={0} max={100} step={10} type='MinRange' change={mindmapFontOpacityChange}/>
                                        </div>
                                        <div className="col-xs-2 db-col-right">
                ...
                <DialogComponent id="fileUploadDialog" ref={dialog => this.fileUploadDialog = dialog} width={"500px"} height={"485px"} header='Upload File' target={this.dlgTarget} isModal={true} animationSettings={this.dialogAnimationSettings} buttons={this.uploadButtons} showCloseIcon={true} allowDragging={true} visible={this.dialogVisibility} content={fileTemplate}/>
                ...
                <DialogComponent id="openTemplateDialog" ref={openTemplateDialog => this.openTemplateDialog = openTemplateDialog} width={"695px"} height="470px" header='Create New Diagram' target={this.dlgTarget} isModal={true} animationSettings={this.dialogAnimationSettings} showCloseIcon={true} allowDragging={true} visible={this.dialogVisibility}/>
                <DialogComponent id="saveDialog" ref={saveDialog => this.saveDialog = saveDialog} width={"335px"} header='Save Diagram' target={this.dlgTarget} isModal={true} showCloseIcon={true} allowDragging={true} animationSettings={this.dialogAnimationSettings} visible={this.dialogVisibility} buttons={this.saveButtons} content={saveTemplate}/>
                <DialogComponent id="moreShapesDialog" ref={moreShapesDialog => this.moreShapesDialog = moreShapesDialog} width={"695px"} height={"470px"} header='Shapes' target={this.dlgTarget} isModal={true} animationSettings={this.dialogAnimationSettings} showCloseIcon={true} allowDragging={true} buttons={this.moreShapesButtons} visible={this.dialogVisibility} content={moreShapeTemplate}/>

                <DialogComponent id="tooltipDialog" ref={tooltipDialog => this.tooltipDialog = tooltipDialog} width={"335px"} header='Edit Tooltip' target={this.dlgTarget} isModal={true} animationSettings={this.dialogAnimationSettings} visible={this.dialogVisibility} showCloseIcon={true} content={this.tootipTemplate} buttons={this.tooltipButtons}/>
                <DialogComponent id="hyperlinkDialog" ref={hyperlinkDialog => this.hyperlinkDialog = hyperlinkDialog} width={"400px"} header='Insert Link' target={this.dlgTarget} isModal={true} visible={this.dialogVisibility} animationSettings={this.dialogAnimationSettings} showCloseIcon={true} buttons={this.hyperlinkButtons} content={hyperLinkTemplate}/>
                ...
                <DialogComponent id="customPropertyDialog" width={"500px"} header='Additional Information' target={this.dlgTarget} isModal={this.isModalDialog} animationSettings={this.dialogAnimationSettings} allowDragging={true} showCloseIcon={true} visible={this.dialogVisibility} ref={customPropertyDialog => this.customPropertyDialog = customPropertyDialog}/>
                ...
                <DialogComponent id="layerDialog" ref={layerDialog => this.layerDialog = layerDialog} width={"300px"} height={"400px"} header='Layers' target={this.dlgTarget} isModal={this.isModalDialog} animationSettings={this.dialogAnimationSettings} allowDragging={true} visible={this.dialogVisibility} content={this.layerFooterTemplate}/>

                <DialogComponent id="themeDialog" ref={themeDialog => this.themeDialog = themeDialog} width={"174px"} header='Themes' target={this.dlgTarget} isModal={this.isModalDialog} animationSettings={this.dialogAnimationSettings} allowDragging={true} visible={this.dialogVisibility} showCloseIcon={true} position={this.themesdialogPosition} created={themeDialogTemplate} content={this.themeTemplate}/>

                <DialogComponent id="deleteConfirmationDialog" ref={deleteConfirmationDialog => this.deleteConfirmationDialog = deleteConfirmationDialog} width={"400px"} header='Delete Field' target={this.dlgTarget} isModal={true} animationSettings={this.dialogAnimationSettings} visible={this.dialogVisibility} showCloseIcon={true} buttons={this.deleteConfirmationButtons} content={this.deleteConformationTemplate}/>
            </div>);
    }
    sendToBack() {
        this.selectedItem.isModified = true;
    ...
    lockObject() {
        this.selectedItem.isModified = true;
        const diagram = this.selectedItem.selectedDiagram;
        for (const value of diagram.selectedItems.nodes) {
            const node = value;
        ...
        for (const item of diagram.selectedItems.connectors) {
    ...
    btnMoreShapes(args) {
        const listSelectedItem = this.moreShapesList.getSelectedItems();
    ...
    listViewSelectionChange(args) {
        document.getElementById('shapePreviewImage').src = require('./assets/dbstyle/shapes_images/' + args.text.toLowerCase() + '.png');
    }
}
;
